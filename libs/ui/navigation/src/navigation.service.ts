...
export class NavigationService {
  ...
  public getNavigationFor(id: string): NavigationDeclaration[] {
  ...
  public getNavigationMapFor<T extends string>(id: string): Record<T, NavigationDeclaration> {
    return Object.fromEntries(Object.entries(this._cfg)
      .filter(e => e[1].slots.some(s => s.id === id))) as Record<T, NavigationDeclaration>
  }
}