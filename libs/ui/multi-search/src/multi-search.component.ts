...
import { FullSearchRedirectComponent } from "./full-search-redirect/full-search-redirect.component";
...
import { SearchResultListSkeleton } from "./search-results-list-skeleton/search-result-list-skeleton.component";
