...
import { CategoriesBffApiService } from "./infrastructure/categories-bff-api.service";
...
export function provideCategoryFeature(c?: { path?: string; useBff?: boolean }): ApplicationConfig {
  ...
  return {
    providers: [
      ...
      { 
        ...
        useClass: useRealApi ? CategoriesBffApiService : CategoryApiService 
      },
