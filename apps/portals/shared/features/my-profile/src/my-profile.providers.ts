...
import { MyProfileService } from "../../../../../../libs/domains/customer/my-profile/application";
import { MY_PROFILE_PROVIDER, MY_PROFILE_UPDATER } from "../../../../../../libs/domains/customer/my-profile/application/ports";
import { MyProfileApiService } from "./infrastructure/my-profile-api.service";
import { AUTHENTICATION_PROVIDER } from "../../../../../../libs/domains/customer/my-profile/application/ports/authentication-provider.port";
...
import { GUEST_PROFILE_PROVIDER } from "../../../../../../libs/domains/customer/my-profile/application/ports/guest-profile-provider.port";
import { of } from "rxjs";
import { GuestProfileDto } from "../../../../../../libs/domains/customer/my-profile/application/models";
