...
export const SAMPLE_ARTICLE: ArticleDto = {
  ...
  excerpt: 'Discover the best productivity apps that can help you streamline your workflow and boost your efficiency.',
  author: 'John Doe',
...
export const TECH_ARTICLE: ArticleDto = {
  ...
  excerpt: 'Explore the cutting-edge technologies shaping the future of software development and digital innovation.',
  author: 'Jane Smith',
  category: 'Technology',
...
export const DESIGN_ARTICLE: ArticleDto = {
  ...
  excerpt: 'Learn essential design principles that can help you create beautiful and user-friendly applications.',
  author: 'Mike Johnson',
  category: 'Design',
